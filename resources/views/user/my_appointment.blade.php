      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('myappointment') }}" style="background-color:greenyellow; clor:white;"  >My Appointment</a>
            </li>
...
<a href=""></a>
        ...
        <tr style="background-color: black" align="center">
            ...
            <td style="padding: 10px;  color:white;"><a onclick="return confirm('are you sure to delete this?')" href="{{url('cancel_appoint',$appoints->id) }}">Cancel</a></td>
        </tr>
